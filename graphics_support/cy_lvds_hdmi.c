...
/* Extern definition */
extern cy_stc_hdmi_display_timings_t displayTimings[];
...
static cy_en_hdmi_trx_status_t Cy_IT6263_InitPeripherals(void)
{
    /* Migrate the functions to PDL */
    /*cy_stc_gpio_pin_config_t hdmi_trx_port_pin_cfg; */
    cy_stc_gpio_pin_config_t hdmi_trx_port_pin_cfg =  { 0 };
    cy_en_hdmi_trx_status_t status = CY_HDMI_TRX_SUCCESS;

    /* Configure the RST control for the chip */
    hdmi_trx_port_pin_cfg.outVal = 1;
...
static cy_en_hdmi_trx_status_t Cy_IT6263_Reset(void)
{
    ...
    Cy_SysLib_DelayUs(CY_IT6263_CMD_IN_BW_DELAY);
...
static cy_en_hdmi_trx_status_t Cy_IT6263_VerifyChipId(void)
{
    ...
    #ifdef DEBUG_IT6263      
    printf("CY_IT6263_CHIP_VENDOR_ID(202) : %u\n\r",readBuffer[0]);
    printf("CY_IT6263_CHIP_DEVICE_ID(19) : %u\n\r",readBuffer[1]);
    printf("CY_IT6263_CHIP_REV_ID(118) : %u\n\r",readBuffer[2]);
    #endif
...
static cy_en_hdmi_trx_status_t Cy_IT6263_HDMI_DetectVideoMode(void)
{
    ...
    if(forceUpdate)
    {
        ...
        #ifdef DEBUG_IT6263      
        printf("CY_HDMI_Transceiver_SetDisplayOption() finished \n\r");
        #endif    
   }
...
{
    cy_en_hdmi_trx_status_t status = CY_HDMI_TRX_SUCCESS;
    uint16_t width = 0, height = 0, fps = 60;
    ...
    switch(videoMode)
    {
          ...
          case CY_HDMI_720x480p60:
              hdmiStatus.hdmiVIC              = CY_HDMI_720x480p60;
          ...
          case CY_HDMI_1280x720p60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1280x720p60;
          ...
          case CY_HDMI_1920x1080i60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1920x1080i60;
          ...
          case CY_HDMI_1440x480p60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1440x480p60;
              hdmiStatus.hdmiVideoPixelClock  = 54000000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU709;
              break;
              
          case CY_HDMI_1920x1080p60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1920x1080p60;
              hdmiStatus.hdmiVideoPixelClock  = 148500000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU709;
          ...
          case CY_HDMI_800x480w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_800x480w60;
              hdmiStatus.hdmiVideoPixelClock  = 33900000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU601;
              break;
              
          case CY_HDMI_720x720w78:
              hdmiStatus.hdmiVIC              = CY_HDMI_720x720w78;
              hdmiStatus.hdmiVideoPixelClock  = 59400000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU601;
              break;
              
          case CY_HDMI_1024x600w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1024x600w60;
          ...
          case CY_HDMI_1280x480w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1280x480w60;
              hdmiStatus.hdmiVideoPixelClock  = 43000000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU601;
              break;
          
          case CY_HDMI_1280x720w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1280x720w60;
              hdmiStatus.hdmiVideoPixelClock  = 74250000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU601;
          ...
          case CY_HDMI_1600x600w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1600x600w60;
              hdmiStatus.hdmiVideoPixelClock  = 66520000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU601;
              break;
              
          case CY_HDMI_1920x720w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1920x720w60;
              hdmiStatus.hdmiVideoPixelClock  = 98900000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU601;
              break;
              
          case CY_HDMI_1920x1080w60:
              hdmiStatus.hdmiVIC              = CY_HDMI_1920x1080w60;
              hdmiStatus.hdmiVideoPixelClock  = 148500000L;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU709;
          ...
          case CY_HDMI_Custom:
              width = displayTimings[NUM_OF_DISPLAY_TIMINGS-1].VEC[0];
              height = displayTimings[NUM_OF_DISPLAY_TIMINGS-1].VEC[5];
              hdmiStatus.hdmiVIC              = CY_HDMI_Custom;
              hdmiStatus.hdmiVideoPixelClock  = width * height * fps;
              hdmiStatus.hdmiPixelRep         = 0u;
              hdmiStatus.hdmiAspectRatio      = CY_HDMI_ASPECT_RATIO_16x9;
              hdmiStatus.hdmiColorimetry      = CY_HDMI_COLORIMETRY_ITU709;
              break;
...
cy_en_hdmi_trx_status_t Cy_HDMI_Transceiver_Init(cy_stc_hdmi_trx_config_t videoFormat)
{
    ...
    /* Check for the custom format */
    if (videoFormat.videoType == CY_HDMI_Custom)
    {
        /* Copy the display timings as per the format */
        for (uint8_t i=0; i<11; i++)
        {
            displayTimings[NUM_OF_DISPLAY_TIMINGS-1].VEC[i] = videoFormat.disptimings[i];
        }
        //memcpy(&displayTimings[NUM_OF_DISPLAY_TIMINGS-1].VEC[0], &videoFormat.disptimings[0], sizeof(videoFormat.disptimings));
    }
